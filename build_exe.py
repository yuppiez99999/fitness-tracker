...
EXCLUDE_MODULES = [
    ...
    'pyarrow', 'sqlalchemy', 'cryptography',
...
cmd = [
    ...
    '--add-data', '体重体脂监控' + os.pathsep + '体重体脂监控',
]
...
cmd += [
    ...
    # 显式声明本地模块
    '--hidden-import', 'ai_coach_engine',
    '--hidden-import', 'fitness_modules',
    '--hidden-import', 'fitness_pkg',
    '--paths', HERE,
]
...
if result.returncode == 0:
    ...
    if os.path.exists(out):
        ...
        total = sum(os.path.getsize(os.path.join(r, f))
                    for r, _, fs in os.walk(os.path.dirname(out))
